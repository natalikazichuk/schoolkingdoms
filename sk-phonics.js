/* ============================================================
   ...
   ОЗВУЧКА:  audio/phon_<word>.mp3       — слово (як нема, синтез en-GB)
             audio/phon_s_<grapheme>.mp3 — окремий звук (s, a, sh, ch…)
   Звуки ОБОВʼЯЗКОВО з mp3: синтез мовлення не вміє вимовляти окремі
   фонеми — «sss» він читає як «ес-ес-ес», «ih» як «ай-ейч», «th» як
   «ті-ейч». Файли для всіх 27 графем уже лежать в audio/; замінити їх
   власним записом можна будь-коли — імена ті самі.
   Поле say лишається тільки як запасний варіант, якщо mp3 не завантажився:
   приголосні там із коротким [ə] («suh», «tuh») — так їх принаймні не
   читають по буквах; голосні синтез усе одно вимовляє приблизно.
   ============================================================ */
(function(){
  'use strict';
