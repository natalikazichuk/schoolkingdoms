...
var DEFAULT_MAP = {
  version: 2,
  tiers: [
    { id:'preschool', icon:'🌱', name:'Дошкільнятко', status:'soon',
      note:'Готуємо майбутнього першачка. Заплановано.',
      /* Дошкілля — повноправний клас із номером 0. Раніше тут був порожній
         grades:[], тож у запасній карті дошкільного класу не існувало
         взагалі: дошкільний контент не мав куди лягти, доки карта не
         прийде з бази. */
      grades:[
        { id:'g0', name:'Дошкільнятко', status:'wip', gradeNum:0,
          /* Предмети ті самі, що й у молодшій школі (ті самі keys і стати),
             щоб дошкільний контент справді мав куди лягти. Порожній
             subjects:[] означав би, що клас є, а покласти в нього нічого. */
          subjects:[
            ...
            { id:'ukr',  icon:'🌺', name:'Українська мова', accent:'#D6577A', statKey:'health', stat:'Здоровʼя ❤️',
              keys:['україн','укр мова','рідна мова','абетк'], topics:[] },
